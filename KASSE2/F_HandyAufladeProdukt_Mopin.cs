...
namespace IS_KASSE
{
    public partial class F_HandyAuflade_Mopin : Form
    {
        ...
        //public iss_HandyAuflade_V1.iss_HandyAuflade_Main Handy = new iss_HandyAuflade_V1.iss_HandyAuflade_Main();
        public Result HandyVerkaufResult = new Result();
        public Int32 CardID = 0;
        public F_HandyAuflade_Mopin()
        {
            InitializeComponent();
        }
