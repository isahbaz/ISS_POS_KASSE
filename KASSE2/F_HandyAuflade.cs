    ...
    public partial class F_HandyAuflade : Form
    {
        ...
        private void F_HandyAuflade_Load(object sender, EventArgs e)
        {
                   ...
                   /* iss_HandyAuflade.iss_HandyAuflade_Main Handy = new iss_HandyAuflade_Main();
                    ...
                    {*/ int listenenSayi = 0;
                        ...
                        for (i = start; i < (limit + start < ToplamKayitSay ? (limit + start) : ToplamKayitSay); i++)
                        {
                            ...
                            Info.Add("cardtyp", dtHandy.Rows[i].ItemArray[10] != "" ? dtHandy.Rows[i].ItemArray[10] : "0");
                            ...
                            try
                            {
                                BtnArtikel1.StateNormal.Back.Image = ImageLoadFromLocal(dtHandy.Rows[i].ItemArray[1].ToString(), dtHandy.Rows[i].ItemArray[9].ToString());
            ...
            if (Program.StopWatch == 1)
            {
                ...
                MessageBox.Show(" Lade Dauer:" + etts2.ToString(@"hh\:mm\:ss\:fff"));
            }
